...
415 POKE 37,2: CALL -922: CALL -998: POKE 36,0:PRINT ID$
420 POKE 37,2: CALL -922: CALL -998: POKE 36,4:PRINT "!"CP
460 POKE 37,2: CALL -922: CALL -998: POKE 36,15:PRINT "!"IN
465 POKE 37,2: CALL -922: CALL -998: POKE 36,20:PRINT "!"MA$
470 POKE 37,2: CALL -922: CALL -998: POKE 36,29:PRINT "!"CP+CP*IN
480 RETURN
10000 GOSUB 100
11000 HOME
